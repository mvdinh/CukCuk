        ...
        <div class="filter-list">
          ...
          >
            <div class="filter-item-header">
              <!-- Checkbox type column header checkbox binds directly to value (1 or 0) and sets active to true -->
              <label v-if="col.type === 'checkbox'" class="checkbox-wrapper">
                <input
                  type="checkbox"
                  :checked="filterStore.columnFilters[col.key].value === '1'"
                  @change="
                    filterStore.columnFilters[col.key].active = true;
                    filterStore.columnFilters[col.key].value = $event.target.checked ? '1' : '0';
                    filterStore.columnFilters[col.key].operator = 'equals';
                  "
                />
                <span>{{ col.label }}</span>
              </label>

              <!-- Other columns bind active state -->
            ...
            <!-- Controls (only for non-checkbox types) -->
            <div
              v-if="col.type !== 'checkbox' && filterStore.columnFilters[col.key].active"
